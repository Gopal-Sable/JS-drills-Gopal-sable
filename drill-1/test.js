...
//    Given the dataset of individuals, write a function that accesses and returns the email addresses of all individuals.
 ...
 console.log("\n\n\n_____________problem two ______________");
    ...
    console.log("Providng different parameter type:", hobbiesOfAge(arrayOfObjects,"abc"));
 ...
 //    Create a function that extracts and displays the names of individuals who are students (`isStudent: true`) and live in Australia.
    ...
    console.log("Answer with correct argument:",isStudentLivesIn(arrayOfObjects,"India"));
...
console.log("with passing different parameter:", objectAt(arrayOfObjects,"abc"));
...
console.log("\n\n\n__________problem Seven ____________");
    console.log("Answer with correct argument:",getNameAndEmail(arrayOfObjects,25));
    console.log("with empty array as parameter: ",getNameAndEmail([]));
    console.log("without passing arguments:",getNameAndEmail());
    console.log("with passing different parameter:", getNameAndEmail(arrayOfObjects,"abc"));
